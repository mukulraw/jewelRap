...
public class Global_variable {
  ...
  public static String base_url = "http://developer.jewelrap.com";
    ...
    public static String get_user_status = base_url + "/user/get_paid_status/";
    public static String inquiry_api = base_url + "/product/inquiry/";
    public static String news_api = base_url + "/api/v1/news/";
    public static String paid_api = base_url + "/user/get_paid_status/";
    ...
    public static String sale_search = base_url + "/api/v1/sale_search/";
