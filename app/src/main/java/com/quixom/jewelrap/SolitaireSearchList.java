...
import com.quixom.jewelrap.Adapter.SearchListAdapter;
...
public class SolitaireSearchList extends AppCompatActivity implements View.OnClickListener {
    ...
    String saleUrl =Global_variable.sale_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if(MainActivity.clickPosition==2)
        {
            serachurl = saleUrl + myUrl;
        }

        Log.e("Searchurl",""+serachurl);

        try {
            decodesUrl = java.net.URLDecoder.decode(serachurl, "UTF-8").replace(" ", "");
            Log.e("**decodurl", decodesUrl);
    ...
    public void parameterDetails() {
        ...
        if (certificate != null && !certificate.equals("") && MainActivity.clickPosition==1) {
