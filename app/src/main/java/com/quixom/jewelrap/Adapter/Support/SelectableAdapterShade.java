 ...
 */
public abstract class SelectableAdapterShade<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    @SuppressWarnings("unused")
    private static final String TAG = SelectableAdapterShade.class.getSimpleName();

    private static SparseBooleanArray selectedItems;

    public SelectableAdapterShade() {
