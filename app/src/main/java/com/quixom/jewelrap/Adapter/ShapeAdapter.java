...
public class ShapeAdapter extends SelectableAdapterShape<ShapeAdapter.ViewHolder> {
    ...
    int categoryId;
    float textsize;
    public ShapeAdapter(ViewHolder.ClickListener clickListener, ArrayList<JewelRapItem> listShape, Context context,int categoryId,float textsize) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void changeColor(ImageView imageView, int r, int g, int b) {
